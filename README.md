...
> Projeto desenvolvido como parte da disciplina de **TECNOLOGIAS PARA A INTERNET** (Uniube) — um site dedicado à adoção responsável e resgate de animais abandonados.
...
- 🐕 **Página Inicial:** Apresentação da ONG e galeria de animais disponíveis.  
- 💚 **Sobre Nós:** História da ONG, missão e equipe de voluntários.  
- 🐾 **Como Ajudar:** Formulário de doações e cadastro de voluntários.  
- ✉️ **Contato:** Informações, tabela de contatos e listas de canais oficiais.  
...
| **Design** | Layout responsivo e paleta verde (tema ecológico) |
...
## 📊 Melhorias Futuras
 - Implementar back-end para gerenciamento de adoções.
...
©2025 PetConnect — Todos os direitos reservados.
